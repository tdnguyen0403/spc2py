...
viscosity = pd.read_csv(os.path.join(_ROOT, 'viscosity.csv')).values
...
model_c4 = pd.read_csv(os.path.join(_ROOT, 'model_c4.csv')).values

model_c4_original = pd.read_csv(os.path.join(_ROOT, 'model_c4_original.csv')).values
